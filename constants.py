...
DESCRIPTIONS = {
    'Cleaner Options': (
        "Choose between safe trimming or aggressive full cleaning.\n\n"
        "• Soft Clean: Trims caches to your configured size limits\n"
        "• Hard Clean: Completely wipes caches and texture database"
    ),
    
    'Soft Clean': (
        "Safely reduces disk usage:\n\n"
        "• Trims Temp/Cache to your configured limit\n"
        "• Trims Thumbnails to your configured limit\n"
        "• Completely clears Packages folder\n\n"
        "No risk of breaking artwork or textures."
    ),
